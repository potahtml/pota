...
follow the AGENTS.md convention (e.g. Aider) read it directly; Claude
Code reaches it via the `@` import at the bottom of this file.
...
source of truth; this file should grow only when the content is
genuinely Claude Code-specific (a new `.claude/rules/` file, a new
subagent, a Claude Code feature).
